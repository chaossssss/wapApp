...
function createMarker(workers, boss) {
    ...
    for (var i = 0, len = workers.length; i < len; i++) {
        ...
        switch (flag) {
            case 1:
                var htm1 = "<div class='bubbleInfo'>" + "<span class='name'>" + workers[i].DefaultService.Name + "</span>" + "<span class='num mapBlue'>5年</span>" + "</div>";
                ...
                break;
            case 2:
                var htm2 = "<div class='bubbleInfo'>" + "<span class='name'>" + workers[i].DefaultService.Name + "</span>" + "<span class='num mapPink'>2年</span>" + "</div>";
            ...
            case 3:
                if (manOrwoman === "0") {
                    var htm3_0 = "<div class='bubbleInfo'>" + "<span class='name'>" + workers[i].DefaultService.Name + "</span>" + "<span class='num mapRed'>男" + workers[i].Age + "</span>" + "</div>";
                    var label = new BMap.Label(htm3_0, opts);
                } else {
                    var htm3_1 = "<div class='bubbleInfo'>" + "<span class='name'>开锁换锁</span>" + "<span class='num mapRed'>女" + workers[i].Age + "</span>" + "</div>";
                ...
                break;
            case 4:
                var htm4 = "<div class='bubbleInfo'>" + "<span class='name'>" + workers[i].DefaultService.Name + "</span>" + "<span class='num mapPurple'>10公里</span>" + "</div>";
                ...
                break;
            case 5:
                var htm5 = "<div class='bubbleInfo'>" + "<span class='name'>" + workers[i].DefaultService.Name + "</span>" + "<span class='num mapOrange'>已备案</span>" + "</div>";
                ...
                break;
            case 6:
                var htm6 = "<div class='bubbleInfo'>" + "<span class='name'>" + workers[i].DefaultService.Name + "</span>" + "<span class='num mapGreen'>" + workers[i].NativePlace + "</span>" + "</div>";
                ...
                break;
            default:
                var htm0 = "<div class='bubbleInfo'>" + "<span>" + workers[i].DefaultService.Name + "</span>"
    ...
    for (var j = 0, len = boss.length; j < len; j++) {
        ...
        switch (flag) {
            case 1:
                var htm1 = "<div class='bubbleInfo'>" + "<span class='name'>" + boss[j].DefaultService.Name + "</span>" + "<span class='num mapBlue'>5年</span>" + "</div>";
                var label = new BMap.Label(htm1, opts);
                label.setStyle({
                    border: 0,
                    backgroundColor: "rgba(0,0,0,0)",
                ...
                break;
            case 2:
                var htm2 = "<div class='bubbleInfo'>" + "<span class='name'>" + boss[j].DefaultService.Name + "</span>" + "<span class='num mapPink'>2年</span>" + "</div>";
                var label = new BMap.Label(htm2, opts);
                label.setStyle({
                    border: 0,
                    backgroundColor: "rgba(0,0,0,0)",
            ...
            case 3:
                if (manOrwoman === "0") {
                    var htm3_0 = "<div class='bubbleInfo'>" + "<span class='name'>" + boss[j].DefaultService.Name + "</span>" + "</div>";
                    var label = new BMap.Label(htm3_0, opts);
                } else {
                    var htm3_1 = "<div class='bubbleInfo'>" + "<span class='name'>开锁换锁</span>" + "<span class='num mapRed'>杭州</span>" + "</div>";
                    var label = new BMap.Label(htm3_1, opts);
                }
                label.setStyle({
                    border: 0,
                ...
                break;
            case 4:
                var htm4 = "<div class='bubbleInfo'>" + "<span class='name'>" + boss[j].DefaultService.Name + "</span>" + "<span class='num mapPurple'>10公里</span>" + "</div>";
                var label = new BMap.Label(htm4, opts);
                label.setStyle({
                    border: 0,
                    backgroundColor: "rgba(0,0,0,0)",
                ...
                break;
            case 5:
                var htm5 = "<div class='bubbleInfo'>" + "<span class='name'>" + boss[j].DefaultService.Name + "</span>" + "<span class='num mapOrange'>已备案</span>" + "</div>";
                var label = new BMap.Label(htm5, opts);
                label.setStyle({
                    border: 0,
                    backgroundColor: "rgba(0,0,0,0)",
                ...
                break;
            case 6:
                var htm6 = "<div class='bubbleInfo'>" + "<span class='name'>" + boss[j].DefaultService.Name + "</span>" + "<span class='num mapGreen'>" + boss[j].NativePlace + "</span>" + "</div>";
                var label = new BMap.Label(htm6, opts);
                label.setStyle({
                    border: 0,
                    backgroundColor: "rgba(0,0,0,0)",
                ...
                break;
            default:
                var htm0 = "<div class='bubbleInfo'>" + "<span>" + boss[j].DefaultService.Name + "</span>"
                    // +   "<span class='num'>杭州</span>"
                    + "</div>";
                var label = new BMap.Label(htm0, opts);
                label.setStyle({
