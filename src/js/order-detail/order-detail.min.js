  ...
  $.ajax({
    ...
    success:function(data){
      ...
      if(data.Body.ServiceProviderType == "2"){
        console.log("工人");
        $("#goToProvider").on("click",function(){
          window.location.href="../worker-detail/worker-info.html?type=" + serviceProviderType + "&id=" + serviceProviderId;
        })       
      }
      if(data.Body.ServiceProviderType == "3"){
        console.log("商户");
        $("#goToProvider").on("click",function(){
          window.location.href="../boss-detail/boss-info.html?type=" + serviceProviderType + "&id=" + serviceProviderId;
        }) 
      }
